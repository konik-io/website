...
:zinvoice-api-config-class: https://github.com/wololock/konik/blob/sdk/src/main/java/io/konik/sdk/ZinvoiceApiConfig.java
:zinvoice-http-client-class: https://github.com/wololock/konik/blob/sdk/src/main/java/io/konik/sdk/http/ZinvoiceHttpClient.java
:lnk_sdk_example: https://github.com/wololock/konik/blob/sdk/src/test/java/io/konik/sdk/examples/BootstrapExampleTest.java
:lnk_sdk_example_raw: https://raw.githubusercontent.com/wololock/konik/sdk/src/test/java/io/konik/sdk/examples/BootstrapExampleTest.java
:invoices_api: https://github.com/wololock/konik/blob/sdk/src/main/java/io/konik/sdk/invoices/InvoicesApi.java
:invoice_api: https://github.com/wololock/konik/blob/sdk/src/main/java/io/konik/sdk/invoice/InvoiceApi.java
:rest_invoices_api: https://github.com/wololock/konik/blob/sdk/src/main/java/io/konik/sdk/invoices/RestInvoicesApi.java
:rest_invoice_api: https://github.com/wololock/konik/blob/sdk/src/main/java/io/konik/sdk/invoice/RestInvoiceApi.java

== Konik SDK

Konik library integrates with {z-rechnung-url}[+Z-Rechnung+] using SDK components. It allows using all Z-Rechnung features directly from your
project that uses Konik. This documentation describes how to start using Konik SDK and makes use of Z-Rechnung features.

=== Before you start

Before you start, go to {api-key-url}[+Z-Rechnung Application Settings+] page and get your API key.

Exemplary API key may look like this: `7c8f89cd-e1d9-44f1-ba3c-62f3ccde1909`


=== Setup SDK config class
...
class as a commonly shared object e.g. Spring Framework bean component. Thanks that you can create it only once and use as a dependency everywhere
...
=== Test classes
:test_case_1: https://github.com/wololock/konik/blob/sdk/src/test/java/io/konik/sdk/invoices/RestInvoicesApiTest.java
:test_case_2: https://github.com/wololock/konik/blob/sdk/src/test/java/io/konik/sdk/invoice/RestInvoiceApiTest.java
:test_case_3: https://github.com/wololock/konik/blob/sdk/src/test/java/io/konik/sdk/http/ZinvoiceHttpClientTest.java
