...
- Automatische Berechnung und Vervollständigung fehleder Beträge. 

Der `Invoice Calculator` berechnet und vervolständing auf wunsch fehlende Beträge für die Gesamtrechnung. 
